...
| [goose](products/goose.md) · [WI-023](../../backlog/items/WI-023-extract-goose.md) | Durable/local product | How do local execution, extensions, MCP/ACP, and session isolation meet at the product boundary? | In progress · pinned `3810898a7447ec3299be72e223d3570a7aabf0ab` |
