...
| Letta Code · [WI-020](../../backlog/items/WI-020-extract-letta-code.md) | Durable/local product | Where do identity, memory writes, archival retrieval, and continual learning live and survive? | Queued |
| Inspect AI · [WI-021](../../backlog/items/WI-021-extract-inspect-ai.md) | Evaluation/optimization | What makes an agent evaluation reproducible, isolated, inspectable, and aggregatable? | Queued |
| Aider · [WI-022](../../backlog/items/WI-022-extract-aider.md) | Durable/local product | How do repository context, editing, validation, and Git history constrain one coding loop? | Queued |
| goose · [WI-023](../../backlog/items/WI-023-extract-goose.md) | Durable/local product | How do local execution, extensions, MCP/ACP, and session isolation meet at the product boundary? | Queued |
| Google ADK · [WI-024](../../backlog/items/WI-024-extract-google-adk.md) | Durable/local product | How do delegation, sessions, evaluation, and multi-language public contracts evolve together? | Queued |
| MCP · [WI-025](../../backlog/items/WI-025-extract-mcp.md) | Interoperability protocol | Which tool/context lifecycle, capabilities, errors, and trust responsibilities cross the client-server boundary? | Queued |
| A2A · [WI-026](../../backlog/items/WI-026-extract-a2a.md) | Interoperability protocol | Which discovery, task, artifact, streaming, and identity semantics cross independently operated agents? | Queued |
