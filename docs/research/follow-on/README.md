...
| [Letta Code](products/letta-code.md) · [WI-020](../../backlog/items/WI-020-extract-letta-code.md) | Durable/local product | Where do identity, memory writes, archival retrieval, and continual learning live and survive? | Done · pinned `ec4e23a85d4aa2a449ed5c7fb0801a0be1bd68d0` |
...
| [Google ADK](products/google-adk.md) · [WI-024](../../backlog/items/WI-024-extract-google-adk.md) | Durable/local product | How do delegation, sessions, evaluation, and multi-language public contracts evolve together? | Done · pinned `1d2d1eda3c9b795cd90ad643390f4da5a8cd27bf` + Java `2b87d65d9704a61ff4668b8c9482a79fef9fe0d4` |
