...
| DSPy · [WI-027](../../backlog/items/WI-027-extract-dspy.md) | Evaluation/optimization | How do metrics, traces, examples, and optimizers turn an agent program into an improvement loop? | In progress · pinned `80b118e52cb1f143a0d80d84685572000c59639e` |
