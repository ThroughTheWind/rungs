...
| --- | --- | --- | --- |
| [Shared spine](SHARED-SPINE.md) · [product template](PRODUCT-TEMPLATE.md) · [evaluation template](EVALUATION-TEMPLATE.md) · [protocol template](PROTOCOL-TEMPLATE.md) · [WI-019](../../backlog/archive/WI-019-follow-on-research-method.md) | Method | Which fields are genuinely comparable, and which evidence rules vary by track? | Ready for extraction |
| [Letta Code](products/letta-code.md) · [WI-020](../../backlog/archive/WI-020-extract-letta-code.md) | Durable/local product | Where do identity, memory writes, archival retrieval, and continual learning live and survive? | Done · pinned `ec4e23a85d4aa2a449ed5c7fb0801a0be1bd68d0` |
| [Inspect AI](evaluations/inspect-ai.md) · [WI-021](../../backlog/archive/WI-021-extract-inspect-ai.md) | Evaluation/optimization | What makes an agent evaluation reproducible, isolated, inspectable, and aggregatable? | Done · pinned `d482209d573cdde116cc0f28abfb01712e91e80c` |
| [Aider](products/aider.md) · [WI-022](../../backlog/archive/WI-022-extract-aider.md) | Durable/local product | How do repository context, editing, validation, and Git history constrain one coding loop? | Done · pinned `5dc9490bb35f9729ef2c95d00a19ccd30c26339c` |
| [goose](products/goose.md) · [WI-023](../../backlog/archive/WI-023-extract-goose.md) | Durable/local product | How do local execution, extensions, MCP/ACP, and session isolation meet at the product boundary? | Done · pinned `3810898a7447ec3299be72e223d3570a7aabf0ab` |
| [Google ADK](products/google-adk.md) · [WI-024](../../backlog/archive/WI-024-extract-google-adk.md) | Durable/local product | How do delegation, sessions, evaluation, and multi-language public contracts evolve together? | Done · pinned `1d2d1eda3c9b795cd90ad643390f4da5a8cd27bf` + Java `2b87d65d9704a61ff4668b8c9482a79fef9fe0d4` |
| [MCP](protocols/mcp.md) · [WI-025](../../backlog/archive/WI-025-extract-mcp.md) | Interoperability protocol | Which tool/context lifecycle, capabilities, errors, and trust responsibilities cross the client-server boundary? | Done · pinned `4df2d6b6e3588efb46e7542d98498e5c630a0a86` · normative `2025-11-25` |
| [A2A](protocols/a2a.md) · [WI-026](../../backlog/archive/WI-026-extract-a2a.md) | Interoperability protocol | Which discovery, task, artifact, streaming, and identity semantics cross independently operated agents? | Done · pinned `1eb4aa03b07589d3a00ce7deab0dde679120ed30` · protocol `1.0.0` |
| [DSPy](evaluations/dspy.md) · [WI-027](../../backlog/archive/WI-027-extract-dspy.md) | Evaluation/optimization | How do metrics, traces, examples, and optimizers turn an agent program into an improvement loop? | Done · pinned `80b118e52cb1f143a0d80d84685572000c59639e` |
| [Follow-on synthesis](synthesis.md) · [WI-028](../../backlog/archive/WI-028-follow-on-research-synthesis.md) | All three | Which results reconcile within a track and which are not commensurable across tracks? | In progress |
