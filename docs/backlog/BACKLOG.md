...
| [WI-065](items/WI-065-fresh-findings-baseline.md) | Make a fresh tracked findings register pass its own gate | feature | `feature/WI-065-fresh-findings-baseline` |
